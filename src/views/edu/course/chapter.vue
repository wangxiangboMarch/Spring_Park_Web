        ...
        <ul class="chanpterList">
            <li v-for="chapter in chapterNestedList" :key="chapter.id">
                <p>
                    ...
                    <!-- <el-button type="text" @click="removeChapter(chapter.id)">删除</el-button> -->
                        <el-button type="text" @click.native="dialogVideoFormVisible=true; chapterId = chapter.id">添加课时
                        </el-button>
                        <el-button type="text" @click.native="editChapter(chapter.id)">编辑</el-button>
                        <el-button type="text" @click="removeChapter(chapter.id)">删除</el-button>
                    </span>
                </p>
